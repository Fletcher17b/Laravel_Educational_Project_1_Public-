<section class="relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4" >
            ...
            <div class="z-10">
                <h1 class="text-6xl font-bold uppercase text-white">
                    <span class="text-white">Jobs</span> <span class="text-black"> for </span> <span class="text-white">Cats</span>
                </h1>
                ...
                <div>
                    <a
                        ...
                        >Sign Up up your Cat for a job</a
                    >
                </div>
            </div>
        </section><?php /**PATH C:\xampp\htdocs\app001\resources\views/partials/_hero.blade.php ENDPATH**/ ?>